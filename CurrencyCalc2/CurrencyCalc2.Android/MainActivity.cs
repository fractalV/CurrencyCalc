...
{
    [Activity(Label = "CurrencyCalc2", Icon = "@mipmap/icon", Theme = "@style/MainTheme.Base", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
